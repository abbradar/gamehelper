...
DATABASES = {
    'default': {
        ...
        'NAME': 'gamehelper',            # Or path to database file if using sqlite3.
        'USER': 'gamehelper',            # Not used with sqlite3.
        'PASSWORD': 'MMaTyhm75tLq2Yz9',  # Not used with sqlite3.
...
STATIC_ROOT = '/srv/http/nginx/static/'
