...
urlpatterns = patterns('',
    ...
    url(r'^games/delete/(?P<game_pk>\d+)/$', views.GameDeleteView.as_view(), {'success_url': abs_url('/games/list')}, name='game_delete'),
    ...
    url(r'^characters/delete/(?P<char_pk>\d+)/$', views.CharacterDeleteView.as_view(), {'success_url': abs_url('/users/detail/me/characters/')}, name='character_delete'),
)
