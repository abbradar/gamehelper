...
urlpatterns = patterns('',
    ...
    url(r'^games/delete/(?P<game_pk>\d+)/$', views.GameDeleteView.as_view(), name='game_delete'),
    ...
    url(r'^characters/delete/(?P<char_pk>\d+)/$', views.CharacterDeleteView.as_view(), name='character_delete'),
)
